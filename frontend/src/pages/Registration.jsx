    ...
    return (
        <div className="w-full h-screen bg-linear-to-l from-[#141414] to-[#0c2025] text-white flex flex-col justify-start items-center">
            ...
            <div className="border w-[90%] max-w-150 h-125 bg-[#00000025] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex flex-col justify-center items-center">
                <form className="w-[90%] h-[90%] flex flex-col justify-start items-center gap-5" onSubmit={handleSignUp}>
                    <div className="w-[90%] h-12.5 bg-[#42656cae] flex justify-center items-center rounded-lg gap-2.5 py-5 cursor-pointer hover:bg-[#1b393fae] transition duration-300" onClick={googleSignUp}><img src={google} alt="" className="w-6.25" />Register with google</div>
                    ...
                    <div className="w-[90%] h-100 gap-4 flex flex-col justify-center items-center">
                        <input type="text" className="w-full h-12.5 border-2 border-[#96969635] backdrop:blur-sm rounded-lg shadow-lg bg-transparent placeholder-[#ffffffc7] px-5 font-semibold" placeholder="name" required value={name} onChange={(e) => setName(e.target.value)} />
                        ...
                        <button className="w-full mt-5 h-12.5 bg-[#6060f5] text-[17px] font-semibold rounded-lg flex justify-center items-center cursor-pointer hover:bg-[blue] transition duration-300">Create Account</button>
                    </div>
                    <p className="flex gap-2.5"><span>Already have an account?</span> <span className="text-[#5555f6cf] text-[17px] font-semibold hover:underline cursor-pointer" onClick={() => navigate("/login")}>Login</span></p>
                </form>
            </div>
        </div>
    )
